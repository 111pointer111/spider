...
const zh: TranslationDictionary = {
  ...
  exported: "已导出到 {path}",
  missingApiKey: "缺少 API Key。请在分支对话图谱设置里填写。",
  missingModel: "缺少模型名称。请在分支对话图谱设置里填写。",
  aiRequestFailed: "AI 请求失败（{status}）。{body}",
  emptyAiResponse: "AI 返回为空。",
  streamUnavailable: "当前接口没有返回可读取的流。",
  settingsTitle: "分支对话图谱",
...
const en: TranslationDictionary = {
  appName: "Branch Chat Map",
  openMap: "Open branch chat map",
  ...
  missingApiKey: "Missing API key. Add one in Branch Chat Map settings.",
  missingModel: "Missing model. Add one in Branch Chat Map settings.",
